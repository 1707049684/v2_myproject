# -*- coding: utf-8 -*-
"""DER++ 基线 · a0910 · random_split（G-NCDM 骨干, alpha=0.1, ΔK=auto_new_concepts(0.34)）。

只跑 DER++ 一种方法，产出 incremental_result/derpp_a0910_random_split.{csv,md}（单行，列同 all_methods）。
a0910 题量大(17746)，务必 GPU 服务器。
运行：cd GNCDM/experiments && python run_derpp_a0910_random_split.py
"""
...
def main():
    ...
    print("\n完成：incremental_result/derpp_a0910_random_split.csv")
