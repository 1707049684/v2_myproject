# -*- coding: utf-8 -*-
"""Alpha sweep on KDD Cup Algebra 2005-2006 random_split — 选 Ours 最优 alpha。
...
数据来自 GNCDM/data/algebra0506kc_*（574 users × 1206 problems × 112 KC，
score=整题全部 step 首答全对）。ΔK 用 auto_new_concepts(0.34) 自动选最冷门概念。
algebra 规模小，CPU 也能跑。产物：
incremental_result/alpha_sweep_algebra_random_split.csv
"""
...
DATA = os.path.join(GNCDM_DIR, "data")
...
def main():
    ...
    out = os.path.join(R.SAVE_DIR, "alpha_sweep_algebra_random_split.csv")
